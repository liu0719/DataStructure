...
int main() {
	...
	printf("______________________翻转______________________\n");
	...
	printf("______________________原数组______________________\n");
	for (int i = 0; i < 15; i++)
	{
		printf("arr1[%d]=%d\n", i, arr1[i]);
	}
	printf("______________________全部数组翻转______________________\n");
	HalfReverse(arr1, 0, 14);
	for (int i = 0; i < 15; i++)
	{
		printf("a[%d]=%d\n", i, arr1[i]);
	}
	printf("______________________前半部分数组翻转______________________\n");
	HalfReverse(arr1, 0, 4);
	for (int i = 0; i <15; i++)
	{
		printf("a[%d]=%d\n", i, arr1[i]);
	}
	printf("______________________后半部分数组翻转______________________\n");
